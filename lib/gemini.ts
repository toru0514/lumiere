...
- hashtags: ハッシュタグ。3〜5個（Instagram は1投稿5個までに制限されている）。投稿内容と関連の強いものだけを厳選し、木工・ハンドメイド・アクセサリー・愛知などのジャンルとブランドタグ（cloud9等）を混在。各要素は先頭の#を付けずタグ文字列のみ
...
- 「cloud9」などのブランドタグ1個＋カテゴリ（例：木のアクセサリー、木の指輪）＋ハンドメイド系＋地域（愛知）から構成する。
